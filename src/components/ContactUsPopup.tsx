            ...
            >
              ...
              <div className="relative z-10 p-8">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={closePopup}
                  className="absolute top-6 right-6 w-8 h-8 bg-gray-100 dark:bg-gray-700 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-full flex items-center justify-center text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-all duration-200"
                >
                  ...
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      <input
                        ...
                        maxLength={30}
                        required
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-4 focus:ring-crimson-200/20 focus:border-crimson-200 dark:bg-[#2A2929] dark:text-white transition-all duration-300 text-sm ${
                    ...
                    >
                      ...
                      <textarea
                        ...
                        required
                        rows={3}
                        className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-4 focus:ring-crimson-200/20 focus:border-crimson-200 dark:bg-[#2A2929] dark:text-white transition-all duration-300 resize-none text-sm hover:border-crimson-200/50"
